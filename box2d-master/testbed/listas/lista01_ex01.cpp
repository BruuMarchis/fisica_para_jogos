...
class Lista1ex01 : public Test //você cria a sua classe derivada da classe base Test
{
public:
	Lista1ex01() {
...
static int testIndex = RegisterTest("Examples", "Lista1ex01", Lista1ex01::Create);
