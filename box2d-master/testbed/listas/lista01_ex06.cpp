...
class Lista1ex06 : public Test //você cria a sua classe derivada da classe base Test
{
public:
	Lista1ex06() {
	...
	void Step(Settings& settings) override
	{
		...
		g_debugDraw.DrawString(5, m_textLine, "Pilhas de caixas e circulos. Eles tem tamanho 4, e são iniciados em uma altura de 5.0 de distancia entre eles.");
		m_textLine += 15;
	}
...
static int testIndex = RegisterTest("__Fisica para Jogos", "Lista1ex06", Lista1ex06::Create);
